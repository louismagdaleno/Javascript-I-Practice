...
console.log(`Car 33 is a ${inventory.find(element => element.id === 33).car_year} ${inventory.find(element => element.id === 33).car_make} ${inventory.find(element => element.id === 33).car_model}` );
